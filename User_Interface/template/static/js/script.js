...
$(document).ready(function () {
	...
	user_id = "default";
	//var len_username = Math.floor((Math.random() * 15) + 1);
...
function action_trigger() {
	...
	$.ajax({
		...
		data: JSON.stringify({ "name": "utter_greet", "policy": "MappingPolicy", "confidence": "0.98" }),
...
//=======================================Record and send ========================
var language = 0;
	   var ch =0;//for change colour
	   function change_back(id){
if (ch==1){document.getElementById("hin").style.backgroundColor = "#e8b3ff";
	  document.getElementById("eng").style.backgroundColor = "#8f00cc";}
if (ch==2){document.getElementById("eng").style.backgroundColor = "#e8b3ff";
	  document.getElementById("hin").style.backgroundColor = "#8f00cc";}
}
	   function langu() {language=1;ch=1;change_back("hin");};
	   function langu1() {language=0;ch=2;change_back("eng");};
           function record() {
              var recognition = new webkitSpeechRecognition();
              //recognition.lang = "hi-IN";
	      if (language==0){recognition.lang="en-IN";}else{recognition.lang = "hi-IN";}
//en-IN
...
//var msg = new SpeechSynthesisUtterance(response[i].textt //msg.lang="hi-IN"
                //window.speechSynthesis.speak(msg);
//=================== set bot response in the chats ===========================================
function setBotResponse(response) {//var msg = new SpeechSynthesisUtterance(response[i].text);msg.lang="hi-IN";window.speechSynthesis.speak(msg);
	...
	setTimeout(function () {
		...
		if (response.length < 1) {
			...
			var fallbackMsg = " Please try again later!!!";
			...
			for (i = 0; i < response.length; i++) {var msg = new SpeechSynthesisUtterance(response[i].text)

				//check if the response contains "text"
				if (response[i].hasOwnProperty("text")) {msg.lang="hi-IN";window.speechSynthesis.speak(msg);
...
$("#profile_div").click(function () {
	$(".profile_div").toggle();
	$(".widget").toggle();
	user_id = makeid(Math.floor((Math.random() * 50) + 10));
});
